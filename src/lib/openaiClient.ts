...
export async function generateDemoScript() {
  const fallback =
    "Hello. This is a short Omriq demo call. No reservations are created in this demo. Thank you, and have a great day.";
  ...
  try {
    ...
    // Common OpenAI billing/limit errors (429 insufficient_quota, etc).
    // For MVP, degrade gracefully so Twilio + ElevenLabs demo still works.
    return fallback;
  }
}
